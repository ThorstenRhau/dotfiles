...
Classic Token, Token Flint, Token Temper, and Token Ultra are all available,
...
`token-theme next` to cycle through all four. The selection is stored under
...
After Token contrib files are regenerated, sync all four appearances into
